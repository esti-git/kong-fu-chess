...
- פרוטוקול בינארי קומפקטי (לא JSON) — הפרויקט כבר עושה את זה חלקית עם המחרוזות הקצרות ב-`protocol/`.
...
*טיוטה לדיון — נכתב לפני קבלת ההצעה הרשמית של שמואל והצוות, לצורך השוואה.*
